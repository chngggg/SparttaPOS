    ...
    <div class="lg:hidden p-4 border-b border-emas/20 bg-sogan-light/20">
        <div class="flex items-center space-x-3">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-krem/60"><?php echo e(auth()->user()->role_name); ?></p>
            </div>
        </div>
    </div>
    <?php endif; ?>
...
</style> --><?php /**PATH C:\Users\MSI\OneDrive\Desktop\Terakhirbisa\SparttaPOS\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>